        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeNumber = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    CancellationReason = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Reason = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Organisations = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    UptUsr = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
